...
# geom_density(bw=0.1) changes the bin width of the kernels
...
# Alpha stands for alpha transparency.  So here, you need 10 points overlaid to have a perfectly opaque point.  Otherwise it was all 
...
# Adding the jitter plot to the violin plot gives you an idea of how many data points there are
...
c + geom_line()
```
# It's trying to connect all the lines which doesn't help.  Try this instead that chunks the data by country
